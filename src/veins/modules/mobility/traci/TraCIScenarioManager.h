...
protected:
     ...
     */
    std::unique_ptr<TraCISubscriptionManagement::ExecutiveSubscriptionManager> subscriptionManager;
     ...
     */
    void processUpdatedVehicles(std::vector<TraCISubscriptionManagement::Vehicle>& updatedVehicles);
     ...
     */
    void processUpdatedPersons(std::vector<TraCISubscriptionManagement::Person>& updatedPersons);

    /**
     * Helper method that takes a list of updated traffic lights and updates
     * the state of the traffic light modules.
     */
    void processUpdatedTrafficLights(std::vector<TraCISubscriptionManagement::TrafficLight>& updatedTrafficLights);
