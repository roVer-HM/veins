...
void DemoBaseApplLayerGeneric::initialize(int stage)
{
    BaseApplLayer::initialize(stage);

    if (stage == 0) {

        initializeFromMobilityModule();
...
void DemoBaseApplLayerGeneric::initializeFromMobilityModule(){
    EV_DEBUG << "DemoBaseApplLayerGeneric: override initializeFromMobilityModule to initialize the correct TraCICommandInterface";
}

void DemoBaseApplLayerGeneric::subscribeToSignals(){
    findHost()->subscribe(BaseMobility::mobilityStateChangedSignal, this);
}

void DemoBaseApplLayerGeneric::unsubscribeFromSignals() {
    findHost()->unsubscribe(BaseMobility::mobilityStateChangedSignal, this);
}

simtime_t DemoBaseApplLayerGeneric::computeAsynchronousSendingTime(simtime_t interval, ChannelType chan)
{
...
void DemoBaseApplLayerGeneric::populateWSM(BaseFrame1609_4* wsm, LAddress::L2Type rcvId, int serial)
{
...
void DemoBaseApplLayerGeneric::receiveSignal(cComponent* source, simsignal_t signalID, cObject* obj, cObject* details)
{
    Enter_Method_Silent();
...
void DemoBaseApplLayerGeneric::handlePositionUpdate(cObject* obj)
{
...
void DemoBaseApplLayerGeneric::handleLowerMsg(cMessage* msg)
{
...
void DemoBaseApplLayerGeneric::handleSelfMsg(cMessage* msg)
{
    switch (msg->getKind()) {
...
void DemoBaseApplLayerGeneric::finish()
{
...
DemoBaseApplLayerGeneric::~DemoBaseApplLayerGeneric()
{
...
void DemoBaseApplLayerGeneric::startService(Channel channel, int serviceId, std::string serviceDescription)
{
...
void DemoBaseApplLayerGeneric::stopService()
{
    cancelEvent(sendWSAEvt);
    currentOfferedServiceId = -1;
}

void DemoBaseApplLayerGeneric::sendDown(cMessage* msg)
{
    checkAndTrackPacket(msg);
    BaseApplLayer::sendDown(msg);
}

void DemoBaseApplLayerGeneric::sendDelayedDown(cMessage* msg, simtime_t delay)
{
    checkAndTrackPacket(msg);
    BaseApplLayer::sendDelayedDown(msg, delay);
}

void DemoBaseApplLayerGeneric::checkAndTrackPacket(cMessage* msg)
{
