 ...
 * This class is completely independent of any traci or mobility model.
 * Use initializeFromMobilityModule() to initialize any mobility and
 * traci interface needed.
 *
 ...
 * @see Decider80211p
 */
class VEINS_API DemoBaseApplLayerGeneric : public BaseApplLayer {

public:
    ~DemoBaseApplLayerGeneric() override;
...
protected:
    ...
    /** @brief this function is called every time the agent receives a position update signal */
...
protected:
    ...
    virtual void subscribeToSignals();
    virtual void unsubscribeFromSignals();
