...
#if !((INET_VERSION == 0x0402) || (INET_VERSION == 0x0403) || (INET_VERSION == 0x0404) || (INET_VERSION == 0x405))
#pragma message("WARNING: Unsupported INET version. Only INET version 4.2 through 4.5 are supported.")
#endif
